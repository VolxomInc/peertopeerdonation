...
<head>
    ...
    <title>AARZ.PK - Live and Love your life</title>
    <style type="text/css">
        body {
        ...
        a.link3{
            background:#ed8c72; color:#ffffff; padding:8px 10px;text-decoration:none;font-size:13px;
        }
        .bgBody{
            background: #F6F6F6;
        }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableContent bgBody" align="center" style="font-family:helvetica, sans-serif;">
    ...
    <tbody>
    <tr>
        <td height="25" bgcolor="#eaeaea" colspan="3"></td>
    </tr>
    <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td valign="top" class="spechide"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                            <tr>
                                <td height="130" bgcolor="#eaeaea">&nbsp;</td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                                ...
                                <td class="movableContentContainer">
                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign="top">
                                            <tbody><tr><td height="25" bgcolor="#eaeaea"></td></tr>

                                            <tr><td height="5" bgcolor="#04660b"></td></tr>
                                                ...
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign="top" class="bgItem">
                                                        <tbody><tr>
                                                            ...
                                                            <td align="center" width="530">
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" style="font-size:32px;color:#072834;font-weight:normal;">
                                                                        Dear {{$display_name}},
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" width="530">
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" style="font-size:14px;color:#333;line-height:19px;">
                                                                        Thank you for choosing Peer to Peer Donation Account.
                                                                        <br>
                                                                        <br>
                                                                        @if(isset($verification_code))
                                                                            <br><b>Verification Code</b>
                                                                            <br> Your Verification Code is : <b>{{$verification_code}}</b>.
                                                                        @endif
                                                                        <br>
                                                                        <br>
                                                                        <br><b>What’s next?</b>
                                                                        <br> Log on to site and begin the journey:
                                                                        <br>
                                                                    </div>
                                                                </div>
                                                            </td>
