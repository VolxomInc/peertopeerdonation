        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-lg-6 col-md-8 offset-lg-3 offset-md-2 pt-5">
                    <form method="post" action="{{ route('auth.verify-user') }}">
                        <input name="_token" type="hidden" value="{{ csrf_token() }}">
                        <div class="form-group">
                            <p class="para text-center">Please enter the verification code which was sent to you in email.</p>
                            <input type="text" class="form-control px-4" required name="code" id="code" placeholder="Verification Code">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-width-cls mt-4">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
